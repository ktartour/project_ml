...
def print_images():
    ...
    col1, col2, col3 = st.columns([1.2, 1.2, 0.6])  # Equal width columns

    # Display images in the columns
    with col1:
        st.markdown(f'<div style="text-align: left;"><img src="{url1}" alt="Image 1"></div>', unsafe_allow_html=True)

    with col2:
        st.markdown(f'<div style="text-align: center;"><img src="{url2}" alt="Image 2"></div>', unsafe_allow_html=True)

    with col3:
        st.markdown(f'<div style="text-align: right;"><img src="{url3}" alt="Image 2"></div>', unsafe_allow_html=True)
